...
<% if(request.getParameter("opt")!=null&&request.getParameter("retailerstatus")!=null)
{
    ...
    ResultSet rs = con.createStatement().executeQuery("SELECT idshop,shopname,username,masterid,shop.status  FROM shop,login where shoptype='Supplier' and shopowner=masterid and login.status='"+request.getParameter("retailerstatus")+"'");
    while (rs.next()) {
