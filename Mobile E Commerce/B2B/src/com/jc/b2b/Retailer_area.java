...
public class Retailer_area extends FragmentActivity {
	int mStackLevel = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_retailer_area);
		...
		Items.add(new ChildItem(new Subscribe_new_items(), "Add New Item"));
		...
		warehouse.add(new ChildItem(new ViewWareHouse(),"View Warehouse"));
		childItems.add(warehouse);
		groupItems.add("Purchases");
		List<ChildItem> Purchases = new ArrayList<ChildItem>();
		Purchases.add(new ChildItem(new MySupplier(), "Place Order"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.retailer_area, menu);
		return true;
	}
	...
	public class FetchShopInfo extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			progress=new ProgressDialog(Retailer_area.this);
		...
		protected String doInBackground(String... params) {
			...
			if (array.length() < 1) {
				startActivity(new Intent(Retailer_area.this,
