 ...
 * 
 */
public class ItemComplaintItem extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 * 
		 * */
		View view = inflater.inflate(R.layout.fragment_item_complaint_item,
				container, false);
	...
	class FetchInfo extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			JSONObject ob = B2BUtils
					.getJSOn("http://10.0.2.2:8080/B2B/itemComplaint.jsp?opt=selecti");
			Iterator<?> it = ob.keys();
			while (it.hasNext()) {
				try {
					...
					for(int i=0;i<a.length();i++)
					{
						...
						citem.add(new ComplaintItem(ab.getString("shopid"), ab.getString("title"), ab.getString("desc"), ci, ab.getString("email"), ab.getString("shopname"), ab.getString("idComplaint"), ab.getString("itemid")));
					}
					child.add(citem);
