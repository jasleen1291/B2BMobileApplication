...
public class DeleteSupplier extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		email.clear();
		id.clear();
		View v= inflater.inflate(R.layout.fragment_delete_supplier, container,
				false);
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				params.add(new BasicNameValuePair("status", "deactivated"));
				...
				param.add(new BasicNameValuePair("opt", "ac"));
				param.add(new BasicNameValuePair("usertype", "supplier"));
		...
		List<NameValuePair> params = new LinkedList<NameValuePair>();
		params.add(new BasicNameValuePair("opt", "ac"));
		params.add(new BasicNameValuePair("usertype", "supplier"));
