 ...
 * 
 */
public class DeleteRetailer extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		email.clear();
		id.clear();
		View v= inflater.inflate(R.layout.fragment_delete_retailer, container,
				false);
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				param.add(new BasicNameValuePair("usertype", "retailer"));
		...
		params.add(new BasicNameValuePair("usertype", "retailer"));
